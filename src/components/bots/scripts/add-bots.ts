...
const API_URL = 'http://localhost:9002/bots'; // Change this to your actual API URL

async function parseConfig(configValue: string): Promise<BotConfig> {
...
async function createBot(token: string, channelId: string, category: string) {
    try {
