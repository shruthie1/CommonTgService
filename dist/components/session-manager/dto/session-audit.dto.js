...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Session string', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateSessionAuditDto.prototype, "sessionString", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Method used to create the session', enum: sessions_schema_1.SessionCreationMethod }),
    (0, class_validator_1.IsEnum)(sessions_schema_1.SessionCreationMethod),
    __metadata("design:type", String)
], CreateSessionAuditDto.prototype, "creationMethod", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Creation message', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateSessionAuditDto.prototype, "creationMessage", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Previous session string', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Session string to update', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdateSessionAuditDto.prototype, "sessionString", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Session status', enum: sessions_schema_1.SessionStatus, required: false }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Revocation reason', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdateSessionAuditDto.prototype, "revocationReason", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Whether session is active', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], UpdateSessionAuditDto.prototype, "isActive", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Usage count', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
], UpdateSessionAuditDto.prototype, "usageCount", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Last error', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdateSessionAuditDto.prototype, "lastError", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'When the session was revoked', required: false }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Phone number to filter by', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], SessionAuditQueryDto.prototype, "mobile", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Status to filter by', enum: sessions_schema_1.SessionStatus, required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(sessions_schema_1.SessionStatus),
    __metadata("design:type", String)
], SessionAuditQueryDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Creation method to filter by', enum: sessions_schema_1.SessionCreationMethod, required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(sessions_schema_1.SessionCreationMethod),
    __metadata("design:type", String)
], SessionAuditQueryDto.prototype, "creationMethod", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Filter by active sessions only', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], SessionAuditQueryDto.prototype, "isActive", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Number of records to return', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Number of records to skip', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Number)
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Filter sessions created after this date', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Date),
    (0, class_validator_1.IsDate)(),
    __metadata("design:type", Date)
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Filter sessions created before this date', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Date),
    (0, class_validator_1.IsDate)(),
    __metadata("design:type", Date)
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Number of active sessions' }),
    __metadata("design:type", Number)
], SessionAuditStatsDto.prototype, "activeSessions", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Number of expired sessions' }),
    __metadata("design:type", Number)
], SessionAuditStatsDto.prototype, "expiredSessions", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Number of revoked sessions' }),
    __metadata("design:type", Number)
], SessionAuditStatsDto.prototype, "revokedSessions", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Number of failed sessions' }),
    __metadata("design:type", Number)
