...
import { TgContext, ChatListResult, ChatStatistics, MessageStats, TopPrivateChatsResult, PerChatCallStats, SelfMessagesInfo, ChatSettingsUpdate, ChatFolderCreateOptions, ChatFolder, ChatMediaCounts, ChatCallHistory, CallHistoryEntry, PaginatedMessages } from './types';
...
export declare function getMessages(ctx: TgContext, entityLike: Api.TypeEntityLike, limit?: number, offsetId?: number): Promise<PaginatedMessages>;
export declare function getAllChats(ctx: TgContext): Promise<ReturnType<Api.TypeChat['toJSON']>[]>;
export declare function getMessagesNew(ctx: TgContext, chatId: string, offset?: number, limit?: number): Promise<PaginatedMessages>;
