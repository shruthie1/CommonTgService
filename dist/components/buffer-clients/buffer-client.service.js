...
let BufferClientService = class BufferClientService {
    ...
    async addNewUserstoBufferClients(badIds, goodIds) {
        ...
        const documents = await this.usersService.executeQuery({ "mobile": { $nin: goodIds }, twoFA: false, lastActive: { $lt: sixMonthsAgo, $ne: "1970-01-01" }, totalChats: { $gt: 100 } }, { tgId: 1 }, badIds.length + 3);
