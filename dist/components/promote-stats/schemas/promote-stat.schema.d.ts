...
export declare const PromoteStatSchema: import("mongoose").Schema<PromoteStat, import("mongoose").Model<PromoteStat, any, any, any, Document<unknown, any, PromoteStat, any, {}> & PromoteStat & {
    ...
    __v: number;
}, any>, {}, {}, {}, {}, import("mongoose").DefaultSchemaOptions, PromoteStat, Document<unknown, {}, import("mongoose").FlatRecord<PromoteStat>, {}, import("mongoose").ResolveSchemaOptions<import("mongoose").DefaultSchemaOptions>> & import("mongoose").FlatRecord<PromoteStat> & {
    _id: import("mongoose").Types.ObjectId;
} & {
    __v: number;
}>;
