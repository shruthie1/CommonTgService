...
export declare class PromoteStatController {
    ...
    create(createPromoteStatDto: CreatePromoteStatDto): Promise<import("src").PromoteStat>;
    findByClient(client: string): Promise<import("src").PromoteStat>;
    update(client: string, updatePromoteStatDto: UpdatePromoteStatDto): Promise<import("src").PromoteStat>;
